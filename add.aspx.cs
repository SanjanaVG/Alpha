        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            
            {
                ...
                else
                {
                    ...
                    Temp= "insert into employee (EmpId,EmpName,DOB,Gender,ContactNo,EmailId,DOJ,Department,Designation,Salary,Password1,RoleId,DeleteFlag) values (@Empid,@Empname,@dob,@gender,@Contactno,@Emailid,@doj,@department,@designation,@salary,@password1,@roleid,'N')";
                    mycmd = new SqlCommand(Temp, con);
                    mycmd.Parameters.Add("@Empid", SqlDbType.Int);
                    ...
                    mycmd.Parameters.Add("@Contactno", SqlDbType.Int);
                    ...
                    mycmd.Parameters[4].Value = int.Parse(TxtContact.Text);
                    mycmd.Parameters[5].Value = TxtEmail.Text;
                    mycmd.Parameters[6].Value = TxtDoj.Text;

                    mycmd.Parameters[7].Value = TxtDept.Text;
                    mycmd.Parameters[8].Value = TxtDept.Text;
                    mycmd.Parameters[9].Value = int.Parse(TxtSal.Text);
                    mycmd.Parameters[4].Value = TxtPass.Text;
                    mycmd.Parameters[9].Value = int.Parse(TxtRoleId.Text);
